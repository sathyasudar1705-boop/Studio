...
const replacements = [
    ...
    { regex: /rgba\(33,\s*150,\s*243,\s*0\.1\)/g, replace: 'rgba(25, 159, 168, 0.1)' },
    { regex: /rgba\(255,\s*152,\s*0,\s*0\.1\)/g, replace: 'rgba(244, 160, 32, 0.1)' },
    { regex: /rgba\(76,\s*175,\s*80,\s*0\.1\)/g, replace: 'rgba(149, 213, 196, 0.1)' },
