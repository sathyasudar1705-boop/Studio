    ...
    return (
        <div className="landing-root">
            <nav className="landing-navbar">
                <span className="landing-logo"><CameraAltIcon className="landing-logo-icon" style={{ marginRight: '10px' }} />LENSORIA</span>
                <div className="landing-nav-links">
                    <span onClick={() => navigate("/login")}>Login</span>
                    <span onClick={() => {
                        const el = document.getElementById("contact-landing");
            ...
            <div className="landing-hero">
                <div className="landing-hero-overlay">
                    ...
                    <p className="landing-subtitle">Professional photography for weddings, birthdays, baby shoots, and more.</p>
                    <button className="landing-cta primary-cta" onClick={() => navigate("/login")}>Book a Shoot</button>
